...
function s1CalendarNav(role,delta){window.s1CalOffset=(window.s1CalOffset||0)+delta;if(role==='athlete')s1LoadAthleteCalendar();else if(role==='coach')s1LoadCoachCalendar()}
